...
def run_tests():
    try :
        conn1 = connect('200.0.0.10', 8087) #crea una instancia de la clase StubRPC
        conn2 = connect('200.100.0.15', 8089) #crea una instancia de la clase StubRPC
    ...
    try:
        ...
        print('=============================\n')
        print('Iniciando prueba servidor ajeno')
        ...
        try:
            ...
            connS1 = connect('200.0.0.10', 8080)
            result = connS1.echo('No response!', notify=True)
            assert result == ""
            ...
            print('Iniciando pruebas de errores, servidor ajeno')
            try:
                connS1 = connect('200.0.0.10', 8080)
                connS1.echo()
            except Exception as e:
            ...
            print("Error durante la ejecución del test con el servidor ajeno:", e)
            return        
